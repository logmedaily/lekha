const { Lekha, LekhaTypes } = require('../lib');

describe('Lekha Logger', () => {
    let logger;
    let consoleOutput = [];
    ...
    test('Disable debug', () => {
        logger.disableType(LekhaTypes.Debug);
    ...
    test('Disable log type', () => {
        logger.disableType(LekhaTypes.Debug); // Disable debug logs
    ...
    test('Enable log type', () => {
        logger.disableType(LekhaTypes.Debug); // Disable debug logs
        logger.enableType(LekhaTypes.Debug); // Enable debug logs
        logger.debug(200, 'Testing', 'This is a debug log');
